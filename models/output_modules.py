...
__all__ = ["Scalar", "DipoleMoment", "ElectronicSpatialExtent", "MaskHead", "EquivariantDipoleMoment", "EquivariantVectorOutput"]

# OutputModel 家族提供原子级 → 图级的多种输出模式：掩码分类、标量（等变/非等变）、偶极矩、电子空间范围、矢量输出，
# 全部统一 pre_reduce / post_reduce 接口，即插即用。

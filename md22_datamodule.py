...
class MD22(Dataset):
    def __init__(self, data_dir, species, positions, energies, forces, smiles=None):
        """
        MD22 Dataset for molecular data1.
        ...
        Methods:
            __getitem__(index):
                Get the data1 for a single molecule.
...
class MD22A(Dataset):
    def __init__(self, data_dir, species, positions, energies, forces, smiles=None, position_noise_scale=0.005):
        """
        MD22 Dataset for molecular data1, applying the noisy node.
...
class MD22DataModule(LightningDataModule):
    def __init__(self, hparams, dataset=None):
        """
        MD22DataModule for managing data1 loading and preprocessing of the MD22 dataset.

        Args:
            hparams (Namespace): Hyperparameters for the data1 module.
        ...
        Methods:
            ...
            train_dataloader():
                Returns the data1 loader for the training dataset.
                
                Returns:
                    DataLoader: DataLoader object for training data1.
            
            val_dataloader():
                Returns the data1 loader for the validation dataset.
                
                Returns:
                    DataLoader: DataLoader object for validation data1.
            
            test_dataloader():
                Returns the data1 loader for the test dataset.
                
                Returns:
                    DataLoader: DataLoader object for test data1.
